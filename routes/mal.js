...
router.post('/create', ensureAuthenticated, function (req, res, next) {
    // Boolean to record failure
    var successfulCreate = true;
    
    // mal: Retrieve associated element valuesfrom page & structure them
    const {
        // --Metadata--
                ...
                .then(data => {
                    ...
                    for (let key of Object.keys(entrySupplemental)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entrySupplemental[key] = databaseDate(entrySupplemental[key]);
                        }
                    }
                    ...
                    for (let key of Object.keys(entryGeneralBoard)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entryGeneralBoard[key] = databaseDate(entryGeneralBoard[key]);
                        }
                    }
                    // Create new update record
                    ...
                    for (let key of Object.keys(entryRepresentationInq)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entryRepresentationInq[key] = databaseDate(entryRepresentationInq[key]);
                        }
                    }
                    // Create new update record
                    ...
                    for (let key of Object.keys(entryMugPurchase)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entryMugPurchase[key] = databaseDate(entryMugPurchase[key]);
                        }
                    }
                    // Create new update record
                    ...
                    var entryFloridaStatue = {
                        MALrelatedID: malID,
                        statuePurchaseStatus:StatuePurchaseStatus,
                        dateRequested:StatueDateRequested,
                    ...
                    for (let key of Object.keys(entryFloridaStatue)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entryFloridaStatue[key] = databaseDate(entryFloridaStatue[key]);
                        }
                    }
                    // Create new update record
                    ...
                    for (let key of Object.keys(entrySocial)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entrySocial[key] = databaseDate(entrySocial[key]);
                        }
                    }
                    // Create new update record
                    ...
                    for (let key of Object.keys(entryHiring)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entryHiring[key] = databaseDate(entryHiring[key]);
                        }
                    }
                    // Create new update record
                    ...
                    for (let key of Object.keys(entryTermination)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entryTermination[key] = databaseDate(entryTermination[key]);
                        }
                    }
                    // Create new update record
                    ...
                    for (let key of Object.keys(entryRefSource)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entryRefSource[key] = databaseDate(entryRefSource[key]);
                        }
                    }
                    // Create new update record
                    ...
                    for (let key of Object.keys(entryRefMgmt)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entryRefMgmt[key] = databaseDate(entryRefMgmt[key]);
                        }
                    }
                    // Create new update record
                    ...
                    for (let key of Object.keys(entryPresentation)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entryPresentation[key] = databaseDate(entryPresentation[key]);
                        }
                    }
                    // Create new update record
                    ...
                    for (let key of Object.keys(entryPotential)){
                        ...
                        if (key.toLowerCase().includes("date")) {
                            entryPotential[key] = databaseDate(entryPotential[key]);
                        }
                    }
                    // Create new update record
